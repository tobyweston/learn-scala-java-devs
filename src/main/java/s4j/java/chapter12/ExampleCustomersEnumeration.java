...
public class ExampleCustomersEnumeration {

    public static void main(String... args) {
        Customers customers = new ThreadSafeCustomers();
        Customer daphne = new Customer("Daphne Blake", "101 Easy St");
        Customer fred = new Customer("Fred Jones", "8 Tuna Lane,");
        Customer norville = new DiscountedCustomer("Norville Rogers", "12 Maple Street");
        ...
        customers.add(velma);
//        customers.enumerate(customer -> {
//            System.out.println(customer.getName() + " total $ " + customer.total());
//            return null;
//        });
